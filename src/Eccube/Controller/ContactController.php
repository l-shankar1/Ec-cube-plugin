        ...
        if ($form->isSubmitted() && $form->isValid()) {
            switch ($request->get('mode')) {
                case 'confirm':
                    ...
                    // {
                    //     $secret = "6LcykxsoAAAAADEPfZv4RnW4n3c_2lrJbUyXvqYK";
                    ...
                    //     {
                    //         var_dump($reCAPTCHA);
                    //         echo '<script>alert("認証エラー")</script>';
                    //         exit();
                    //     }
                    // }
                    // else
                    // {
                    //     var_dump(json_decode(file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=6LcykxsoAAAAADEPfZv4RnW4n3c_2lrJbUyXvqYK&response=".$_POST["recaptchaResponse"])));
                    // }
                    $secretKey  = "6Lc93gYoAAAAABNbopczE4r6WW_3a8LfRvDtLCj6";
